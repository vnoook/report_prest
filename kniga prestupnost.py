...
for i_list in xl_cell_begin:
    ...
    # wb_prestup_s - лист в шаблоне, wb_file_data_s - лист в файле с данными
    wb_prestup_s = wb_prestup[str(xl_cell_begin[str(i_list)][0])]
    ...
    if i_list == '2':
        ...
        cells_range = wb_file_data_s[
                                    xl_cell_begin[str(i_list)][1].split(':')[0]:
